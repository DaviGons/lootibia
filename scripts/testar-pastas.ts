 ...
 *
 * Assinando um JWT com `sub = usuario_id`, por `lib/supabase/jwt.ts`. Usar a
 * chave secreta seria mais fácil e testaria a coisa errada: ela **ignora a
 * RLS**, e é justamente a RLS que estava quebrada.
 */
