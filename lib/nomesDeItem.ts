 ...
 * 2. 138 itens distintos de 9 sessões reais: **zero** pares singular/plural.
 ...
 * 2026-09-23: **138 de 138**, zero exceções — e os três últimos chegaram depois de
 * a regra estar escrita, com hunts novas importadas. Rodar de novo quando
 * aparecer item novo: é ele que avisa se a convenção do wiki mudou.
 */
