...
1. ~~**Plural dos nomes.**~~ **RESOLVIDO em 2026-09-22 — e a premissa estava errada.** Este item
   ...
   traz `413x a great mana potion`: singular, com artigo, na quantidade 413. E os 138 itens de 9
   ...
   `scripts/conferir-itens.ts`: **138 de 138** itens do banco encontram página, sem exceção.
